...
# File versions
version_saved = 'OPB_DEP_exc_lPL.xlsx' 

directory = Path("c:/D/ReplModel_2021/")
repl_dataset_f = "Model_Datasets/Repl_Dataset_2021.zip"
planogram_f = 'Model_Datasets/#2020/Planogram_IX_2019.zip'
items_sold_f = 'Model_Datasets/#2020/ItemsSold_X_2019.zip' # 30.09-27.10
stock_f = 'Model_Datasets/#2020/Stock_X_2019.zip' # 30.09-27.10
ops_dev_f = 'Model_Datasets/#2020/OpsDev_XI_2019.zip'

volumes_f = 'Model_Datasets/Volumes_14weeks_2020.xlsx' # 14 Weeks from 2020 - weeks 14 - 27 (01.06.2020 - 06.09.2020) with excluded promo cases (data from Adri: SRD) and customized Volumes (GM/GRO)
excel_inputs_f = 'c:/D/ReplModel_2021/Model_Inputs/Stores_Inputs_2021.xlsx'
pallet_capacity_f = 'Model_Datasets/Pallet_Capacity_P8_2020.csv'
case_capacity_f = 'Model_Datasets/Case_Capacity_P8_2020.csv' 
losses_f = 'Model_Datasets/loss_p8_2020.zip' # P8 2020
most_f = 'Model_Inputs/MOST_Replenishment_2021_change16.xlsb' 
add_hrs_produce = 'c:/D/ReplModel_2021/Summary/Q1 2021/Additional HoursProduce.xlsx'

act_model_outputs = 'Model_Outputs/OPB_DEP_Budgeted.xlsx' 
...
if DATASET_TPN_FUNC == True:
    ...
    Repl_Dataset = rmf.ReplDatasetTpn(directory,store_inputs,planogram_f,stock_f,ops_dev_f,items_sold_f)
    if DATASET_TPN_SAVE == True:
        file_name = f'Model_Datasets/Repl_Dataset_2019_{version_saved}.csv'
        Repl_Dataset.to_csv(directory / file_name, index=False)
...
if RUN_MODEL == True:
    ...
    time_start = CurrentTime()
    Parameters_Rtc_Waste = rmf.RtcParameters(directory,losses_f,LOSS_UNIT_DAYS)
    ...
    # Adjustment, Customization, Additional Hours 
    ...
    opb_dep = rmf.AdditionalHoursProduce(add_hrs_produce,opb_dep) # we're adding hours for Produce. Explanation in "add_hrs_produce" file
    ...
    if BI_REPORT == True:
        df_sort_tbl, df_hours, df_drivers = rmf.Model_Summary_BI(Time_Value,'TypeVersionNumber')
